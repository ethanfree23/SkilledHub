        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4">
              <Link
                to="/dashboard"
                className="px-3 py-2 font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md"
              >
                Dashboard
              </Link>
              <Link
                to="/crm"
                className="px-3 py-2 font-medium text-blue-600 bg-blue-50 rounded-md"
              >
                CRM
              </Link>
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-600">
              ...
              <span className="ml-2 px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded-full capitalize">{user?.role}</span>
            </span>
            <button
              type="button"
              onClick={onLogout}
